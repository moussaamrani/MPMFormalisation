...
\begin{Definition}[\label{def:Implementation}Implementation $\rightsquigarrow$]
...
\begin{Definition}[\label{def:AbstractFormalism}Abstract Formalism]
   An \emph{abstract formalism} $F^\star = 
...
\cite{Mustafiz-etAl:2012,TR:Lucio-Mustafiz-etAl:2012}, we allow the use of 
abstract formalisms as source and target names instead of only languages: this 
extension confer users the possibility of defining ''template'' 
transformations. 
